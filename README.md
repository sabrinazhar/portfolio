...
| [🐶 Puppy Pilot](https://github.com/sabrinazhar/puppy-pilot) <br>📄[Project Summary (PDF)](https://1drv.ms/b/c/6d029b9dc5e627eb/IQA0CG9sMUnWQIU0oF5VxP1CAQr62LcB79zjlvDABR_0n-Y?e=cFIO7t) | Full-stack Flask web app for pet activity tracking with authentication, admin dashboard, data visualisation, subscriptions & Docker deployment. | Python, Flask, SQLAlchemy, SQLite, HTML/CSS, Jinja2, Pandas, Docker |
